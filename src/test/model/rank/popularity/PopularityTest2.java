...
public class PopularityTest2 {
	...
	/**
	 * D:\workspace_j2ee\Casual\data\tests\PopularityTest2.jpg
	 */
	@Test
	public void testPopularity() {
		...
		assertEquals(relationships.get(0).getScore(), 2.5d, delta);
		...
		assertEquals(relationships.get(2).getScore(), 1.1d, delta);
	}
