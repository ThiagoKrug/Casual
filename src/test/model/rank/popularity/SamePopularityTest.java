...
public class SamePopularityTest {
	...
	/**
	 * D:\workspace_j2ee\Casual\data\tests\SamePopularityTest.jpg
	 */
	@Test
	public void testPopularity() {
		...
		assertEquals(relationships.get(0).getPerson2().getName(),
				"Líbero Rodrigues");
		assertEquals(relationships.get(0).getScore(), 2.0d, delta);
		assertEquals(relationships.get(1).getPerson2().getName(),
				"Leandro Lunkes Amaral");
		assertEquals(relationships.get(1).getScore(), 2.0d, delta);
	}
